...
def send_email():
    ...
    from_email = "manaprimera@gmail.com"  # Update with your email
    password = "dhdm blbm nxly weup"  # Update with your email password

    # Create a multipart message
    msg = MIMEMultipart()
    msg['From'] = from_email
    msg['To'] = recipient_email
    msg['Subject'] = "Morning 1st Hour Mismatch Student List , Date = " + date + ", Time = " + time.strftime('%I:%M:%S %p')

    body = "Please find the attached attendance report. Kindly check with the students in the class."
